...
// Using let
let name="Rachel"; // Define a string here, e.g., "Juan Cruz"
let age=19; // Define a number here, e.g., 30
let isStudent=true; // Define a boolean here, e.g., true or false
let hobbies=['listening to music', 'watching anime', 'watching reels']; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const favoriteBooks = ["He's Into Her", "The Four Bad Boys and Me", "Crime and Punishment"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
var temperature = '29.4'; // Define a number here, e.g., 22.5
